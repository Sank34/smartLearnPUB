...
The quiz system is designed to accept exactly **5 questions** (i'll probably release a more extensible version of it, since the quiz system i'm using right now was made in 2022, back when i didn't had that much experience).
...
*Some web assets were taken from tutorials on youtube, so if you find bugs regarding responsiveness plz let me know!*